...
<form action="${pageContext.request.contextPath}/login" class="user-form">
    <h2 class="user-form-title">Rejestracja na ParagraphGame zakończyła się sukcesem</h2>
    <h2 class="user-form-title">Zaloguj się i rozpocznij swoją przygodę...</h2>
